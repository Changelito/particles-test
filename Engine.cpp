...
void Engine::draw()
{
    m_Window.clear(); // Clear the window with the default background color
    for (const auto& particle : m_particles) {
        m_Window.draw(particle); // Draw each particle in the vector
    }
    m_Window.display(); // Display everything on the window
}
